...
tools: ['execute/getTerminalOutput', 'execute/runTask', 'execute/getTerminalOutput', 'execute/createAndRunTask', 'execute/runInTerminal', 'read/problems', 'read/readFile', 'read/terminalSelection', 'read/terminalLastCommand', 'edit/createDirectory', 'edit/createFile', 'edit/editFiles', 'search', 'web', 'todo']
...
**Allowed Input State**: CONTRACT or IMPLEMENTED  
**Allowed Output State**: SAME or VERIFIED (gate update)  
**Primary Transformation**: Security review; set security gate; raise blockers
...
2. Retrieve prior security decisions from .github/security/
...
6. **Store security patterns and decisions** in `./.agent-output/security/` for continuity
